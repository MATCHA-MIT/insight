...
config cfg;
    ...
    instance correctness.dut liblist uArchLib;
endconfig
`endif
...
module correctness(
    ...
    SodorInternalTile sodor_core(.clock(gclk_sodor), .reset(rst),
    ...
    assign dut_commit.commit_target = kronos.dut.cpu.cpu.u_ex.regwr_en ? kronos.dut.cpu.cpu.u_ex.regwr_sel : 6'd0;
