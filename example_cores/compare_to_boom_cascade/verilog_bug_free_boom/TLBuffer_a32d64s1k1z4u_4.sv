...
module TLBuffer_a32d64s1k1z4u_4(	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9]
  ...
  Queue2_TLBundleA_a32d64s1k1z4u_TestHarness_UNIQUIFIED nodeOut_a_q(	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
    .io_enq_ready        (_nodeOut_a_q_io_enq_ready),
    .io_enq_valid        (auto_in_a_valid),
    .io_enq_bits_opcode  (auto_in_a_bits_opcode),
    .io_enq_bits_param   (3'h0),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25, generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_enq_bits_size    (auto_in_a_bits_size),
    .io_enq_bits_source  (1'h0),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25, generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_enq_bits_address (auto_in_a_bits_address),
    .io_enq_bits_mask    (auto_in_a_bits_mask),
    .io_enq_bits_data    (auto_in_a_bits_data),
    .io_enq_bits_corrupt (1'h0),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25, generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue2_TLBundleD_a32d64s1k1z4u_TestHarness_UNIQUIFIED nodeIn_d_q(	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
