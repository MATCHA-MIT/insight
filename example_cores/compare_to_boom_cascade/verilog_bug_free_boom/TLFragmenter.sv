...
module TLFragmenter(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  output [11:0] auto_anon_out_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  ...
  input  [11:0] auto_anon_out_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25]
  ...
  wire        drop = ~(auto_anon_out_d_bits_opcode[0]) & ~(auto_anon_out_d_bits_source[4] ? dFirst : auto_anon_out_d_bits_source[2:0] == 3'h0);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:204:41, :205:29, :206:30, :231:54, :234:{20,30,33,37}]
  ...
  Repeater_TLBundleA_a32d64s7k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_anon_in_d_bits_source = auto_anon_out_d_bits_source[11:5];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :238:47]
