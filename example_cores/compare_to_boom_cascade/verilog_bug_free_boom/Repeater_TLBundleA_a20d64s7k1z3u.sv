...
module Repeater_TLBundleA_a20d64s7k1z3u(	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
  ...
  input  [19:0] io_enq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  output [19:0] io_deq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  reg  [19:0] saved_address;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
        ...
        saved_address = {_RANDOM[2'h0][31:17], _RANDOM[2'h1][4:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_mask = _RANDOM[2'h1][12:5];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_corrupt = _RANDOM[2'h3][13];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
