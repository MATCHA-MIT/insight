...
module ScratchpadSlavePort(	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
  ...
  output [33:0] io_dmem_req_bits_addr,	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:44:16]
  ...
  output [63:0] io_dmem_s1_data_data,	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:44:16]
  input         io_dmem_resp_valid,	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:44:16]
  input  [63:0] io_dmem_resp_bits_data_raw	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:44:16]
);
  ...
  reg  [11:0]     acq_source;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:62:18]
  reg  [31:0]     acq_address;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:62:18]
  reg  [7:0]      acq_mask;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:62:18]
  reg  [63:0]     acq_data;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:62:18]
  ...
  wire            _nodeIn_d_bits_data_T = state == 3'h2;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, generators/rocket-chip/src/main/scala/util/package.scala:16:47]
  ...
  wire            _io_dmem_req_bits_T = state == 3'h3;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, :113:57]
  ...
  wire [31:0]     _io_dmem_req_bits_T_1_address = _io_dmem_req_bits_T ? acq_address : auto_in_a_bits_address;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:62:18, :113:57, :119:41]
  ...
  wire [1:0]      _io_dmem_req_bits_mask_full_desired_mask_T = {_io_dmem_req_bits_T_1_address[0] | (|io_dmem_req_bits_req_size), ~(_io_dmem_req_bits_T_1_address[0])};	// @[generators/rocket-chip/src/main/scala/rocket/AMOALU.scala:20:{27,42,53}, :21:22, :22:16, generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:119:41]
  wire [3:0]      _io_dmem_req_bits_mask_full_desired_mask_T_1 = {(_io_dmem_req_bits_T_1_address[1] ? _io_dmem_req_bits_mask_full_desired_mask_T : 2'h0) | {2{io_dmem_req_bits_req_size[1]}}, _io_dmem_req_bits_T_1_address[1] ? 2'h0 : _io_dmem_req_bits_mask_full_desired_mask_T};	// @[generators/rocket-chip/src/main/scala/rocket/AMOALU.scala:20:{22,27,42,47,53}, :21:22, :22:16, generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:119:41]
  wire            nodeIn_d_valid = io_dmem_resp_valid | state == 3'h5;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, :125:{41,50}]
  reg  [63:0]     nodeIn_d_bits_data_r;	// @[generators/rocket-chip/src/main/scala/util/package.scala:88:63]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
    if (reset)	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
    ...
    else if (auto_in_a_valid & ready | _io_dmem_req_bits_T)	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:112:35, :113:{38,48,57}]
      ...
      state <= 3'h5;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24]
      ...
      state <= 3'h2;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24]
    if (ready & auto_in_a_valid) begin	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:112:35, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
    ...
    logic [31:0] _RANDOM[0:5];	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
    initial begin	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
        for (logic [2:0] i = 3'h0; i < 3'h6; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
        end	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
        state = _RANDOM[3'h0][2:0];	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24]
        acq_opcode = _RANDOM[3'h0][5:3];	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, :62:18]
        acq_param = _RANDOM[3'h0][8:6];	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, :62:18]
        acq_size = _RANDOM[3'h0][10:9];	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, :62:18]
        acq_source = _RANDOM[3'h0][22:11];	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, :62:18]
        acq_address = {_RANDOM[3'h0][31:23], _RANDOM[3'h1][22:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24, :62:18]
        acq_mask = _RANDOM[3'h1][30:23];	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :62:18]
        acq_data = {_RANDOM[3'h1][31], _RANDOM[3'h2], _RANDOM[3'h3][30:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :62:18]
        nodeIn_d_bits_data_r = {_RANDOM[3'h4], _RANDOM[3'h5]};	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, generators/rocket-chip/src/main/scala/util/package.scala:88:63]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_a_ready = ready;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :112:35]
  ...
  assign io_dmem_req_bits_addr = {2'h0, _io_dmem_req_bits_T_1_address};	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :95:16, :119:41]
