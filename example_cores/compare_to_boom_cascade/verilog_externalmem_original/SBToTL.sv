...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire [115:0]    _GEN_0 = {io_addrIn[127:14], ~(io_addrIn[13:12])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [114:0]    _GEN_1 = {io_addrIn[127:21], io_addrIn[20:17] ^ 4'h8, io_addrIn[15:12]};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [110:0]    _GEN_2 = {io_addrIn[127:26], io_addrIn[25:21] ^ 5'h10, io_addrIn[19:16]};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [101:0]    _GEN_3 = {io_addrIn[127:28], ~(io_addrIn[27:26])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [115:0]    _GEN_4 = {io_addrIn[127:29], io_addrIn[28:12] ^ 17'h10020};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [108:0]    _GEN_5 = {io_addrIn[127:32], io_addrIn[31:19] ^ 13'h1000};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [103:0]    _GEN_6 = {io_addrIn[127:32], io_addrIn[31:24] ^ 8'h81};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [102:0]    _GEN_7 = {io_addrIn[127:32], io_addrIn[31:25] ^ 7'h41};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [101:0]    _GEN_8 = {io_addrIn[127:32], io_addrIn[31:26] ^ 6'h21};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [100:0]    _GEN_9 = {io_addrIn[127:32], io_addrIn[31:27] ^ 5'h11};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire [103:0]    _GEN_10 = {io_addrIn[127:32], io_addrIn[31:24] ^ 8'h90};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46}]
  wire            io_rdLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  wire            io_wrLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  ...
  wire            _GEN_11 = sbState == 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :349:19]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
      if (~reset & ~(_GEN_11 | _nodeOut_a_valid_T | _nodeOut_a_valid_T_1 | _rdTxValid_T | _io_wrDone_T)) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:{25,62}, :322:18, :338:29, :349:19, :373:{12,35}, :374:44, :375:45, :376:45]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
      ...
      if (_GEN_11) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:349:19]
  ...
  Queue2_TLBundleD_a32d8s1k2z4u d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_out_a_bits_address = io_addrIn[31:0];	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:31]
