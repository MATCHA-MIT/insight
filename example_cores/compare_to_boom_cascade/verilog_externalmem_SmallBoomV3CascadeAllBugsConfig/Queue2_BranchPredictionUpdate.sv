...
module Queue2_BranchPredictionUpdate(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  assign io_deq_bits_br_mask = _ram_ext_R0_data[3:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_idx_valid = _ram_ext_R0_data[4];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_idx_bits = _ram_ext_R0_data[6:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_is_br = _ram_ext_R0_data[7];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
