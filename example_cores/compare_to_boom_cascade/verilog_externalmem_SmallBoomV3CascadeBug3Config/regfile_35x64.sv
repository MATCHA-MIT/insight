...
module regfile_35x64(	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
  input  [5:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [63:0] R0_data,
  ...
  reg [63:0] Memory[0:34];	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
