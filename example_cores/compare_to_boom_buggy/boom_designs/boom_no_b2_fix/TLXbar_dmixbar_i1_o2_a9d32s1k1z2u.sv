...
module TLXbar_dmixbar_i1_o2_a9d32s1k1z2u(	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:74:9]
  ...
  wire [4:0] _GEN = auto_anon_in_a_bits_address[6:2] ^ 5'h11;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:31, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:222:41]
  wire       requestAIO_0_0 = auto_anon_in_a_bits_address[8:6] == 3'h0 | {auto_anon_in_a_bits_address[8:7], _GEN[4:2], _GEN[0]} == 6'h0 | {auto_anon_in_a_bits_address[8:7], auto_anon_in_a_bits_address[6:3] ^ 4'hB} == 6'h0 | {auto_anon_in_a_bits_address[8:7], ~(auto_anon_in_a_bits_address[6:5])} == 4'h0 | {auto_anon_in_a_bits_address[8], ~(auto_anon_in_a_bits_address[7])} == 2'h0 | auto_anon_in_a_bits_address[8];	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:222:41, :291:92]
  wire       requestAIO_0_1 = {auto_anon_in_a_bits_address[8:7], auto_anon_in_a_bits_address[6:4] ^ 3'h4, auto_anon_in_a_bits_address[2]} == 6'h0 | {auto_anon_in_a_bits_address[8:7], auto_anon_in_a_bits_address[6:3] ^ 4'hA} == 6'h0;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:138:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:222:41, :291:92]
