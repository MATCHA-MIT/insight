...
module TLROM(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9]
  input         clock,	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9]
  input         reset,	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9]
  ...
  wire [511:0][63:0] _GEN =
    '{64'h0,
      ...
      64'h0,
      64'h0,
      64'h680A000034020000,
      64'h10000000,
      64'h1100000028000000,
      64'hA00A000038000000,
      64'hD40C0000EDFE0DD0,
      64'h1330200073,
  ...
  assign auto_in_a_ready = auto_in_d_ready;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9]
  assign auto_in_d_valid = auto_in_a_valid;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9]
  assign auto_in_d_bits_size = auto_in_a_bits_size;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9]
  assign auto_in_d_bits_source = auto_in_a_bits_source;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9]
  assign auto_in_d_bits_data = (|(auto_in_a_bits_address[15:12])) ? 64'h0 : _GEN[auto_in_a_bits_address[11:3]];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:49:9, :63:34, :64:64, :65:{47,53}]
endmodule
