...
module Queue2_TLBundleA_a32d64s5k2z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input         io_enq_bits_user_amba_prot_privileged,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input         io_enq_bits_user_amba_prot_secure,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output        io_deq_bits_user_amba_prot_bufferable,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_bits_user_amba_prot_modifiable,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_bits_user_amba_prot_readalloc,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_bits_user_amba_prot_writealloc,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_bits_user_amba_prot_privileged,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_bits_user_amba_prot_secure,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_bits_user_amba_prot_fetch,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  wire [126:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x127 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_mask, 1'h0, io_enq_bits_user_amba_prot_secure, io_enq_bits_user_amba_prot_privileged, 4'h0, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[47];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[48];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[49];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[50];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[51];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[52];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[53];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[61:54];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[125:62];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[126];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
