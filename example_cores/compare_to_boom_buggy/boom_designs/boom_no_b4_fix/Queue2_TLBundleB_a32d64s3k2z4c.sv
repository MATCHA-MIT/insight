...
module Queue2_TLBundleB_a32d64s3k2z4c(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x53 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({9'hFF, io_enq_bits_address, 7'h6, io_enq_bits_param, 3'h6})	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14, :256:91]
  ...
  assign io_deq_bits_corrupt = _ram_ext_R0_data[52];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
