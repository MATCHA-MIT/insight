...
`define CHECKER_MaxNumTracedInstructions 8
`define CHECKER_MAX_EXECUTION_WINDOW 32'd90
...
// STEP: Same initial memory
    ...
    initial begin
        ...
        // ------------------------
        boom.dut.BoomTile.core.csr.reg_mtvec        = 32'h0001_0000;
        boom.dut.BoomTile.core.csr.reg_mepc         = 40'h0001_0000;
        ...
        // ------------------------
        sodor_core.core.d.csr.reg_mtvec             = 29'h0001_0000;
        sodor_core.core.d.csr.reg_mepc              = 31'h0001_0000;
