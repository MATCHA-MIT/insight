...
set_prove_per_property_max_time_limit 2400s
set_prove_time_limit 2400s
...
set RV32I_OPCODE_TEST_OPCODE2 "7'b0110011, 7'b0010011, 7'b1100011, 7'b1101111,  7'b1100111, 7'b0110111, 7'b0010111,7'b0001111, 7'b1110011, 7'b0000011, 7'b0100011"
...
abstract -init_value {sodor_core.memory.mem_ext.Memory[0]}
abstract -init_value {kronos.dut.mem[0]}
abstract -init_value {sodor_core.memory.mem_ext.Memory[1]}
abstract -init_value {kronos.dut.mem[1]}
abstract -init_value {sodor_core.memory.mem_ext.Memory[2]}
abstract -init_value {kronos.dut.mem[2]}
abstract -init_value {sodor_core.memory.mem_ext.Memory[3]}
abstract -init_value {kronos.dut.mem[3]}
