      ...
      unique case(funct3)
        ...
        3'b011: begin // CSRRC
          ...
          case (IR[31:20])
            ...
            MCYCLE, MINSTRET, MCYCLEH, MINSTRETH: begin
              instr_valid = 1'b1;
            end
            default: begin
              illegal_csr = 1'b1;
...
assign illegal = CATCH_ILLEGAL_INSTR ? (~instr_valid | illegal_opcode | illegal_csr) : 1'b0;
...
always_ff @(posedge clk) begin
  if (~rstz) begin
    ...
    if (flush) begin
      ...
      decode.op1 <= op1;
      decode.op2 <= op2;
      decode.rs1_data <= rs1_data;
      decode.rs2_data <= rs2_data;
