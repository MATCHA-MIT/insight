...
private:
    ...
    bool m_traceConditions = false; // main switch: --trace-conditions
...
public:
    ...
    bool traceConditions() const { return m_traceConditions; }
    void traceConditions(bool flag) { m_traceConditions = flag; }
