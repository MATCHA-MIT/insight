...
#include "V3AddCondPass.h"  // For logging conditions of assignments
#include "V3CondDumpPass.h" // For emitting condition mapping for assignments
...
static void process() {
    {
        ...
        V3AddCondPass::run(v3Global.rootp());
        ...
        V3CondDumpPass::run(v3Global.rootp()); // Emit condition mapping for assignments
